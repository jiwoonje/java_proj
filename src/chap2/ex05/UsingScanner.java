...
public class UsingScanner {
	...
	public static void main(String[] args) {
		...
		// 외부의 라이브러리 사용 하기 : 자바에서 만들어진 클래스의 묶음을 라이브러리라 함
		...
		/* Scanner : 콘솔로부터 입력값을 받아오는 클래스 (객체)
		  		...
		  		- java.util.Scanner : 클래스의 전체 이름
		  		- ctrl + shift + o : 자동으로 import
		  		- 콘솔에서 값을 넣고 Enter(or space)를 넣으면, 다음 스캐너에서 입력 대기
		 */
		
		// 스캐너 객체 생성
		// 참조타입 객체변수명 = new(Heap에 객체 값을 저장하겠다)
		...
		System.out.println("아버님 입력을 입력하세요 >>> ");
		fName = sc.next();		// sc.next() : 콘솔로부터 "문자열"을 인풋 받음. 콘솔에서 input을 대기
		
		System.out.println("어머님 입력을 입력하세요 >>> ");
		mName = sc.next();
		
		System.out.println("나의 입력을 입력하세요 >>> ");
		myName = sc.next();
		...
		// 스캐너로 변수의 값을 할당
		System.out.println("aa bb cc 변수에 정수 값을 공백으로 입력 하세요. >>>");
